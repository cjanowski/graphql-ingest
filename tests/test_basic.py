...
These tests verify that the core components can be imported and basic functionality works.
"""
...
def test_file_contents(file_name, expected_content):
    ...
    assert expected_content in content, f"Expected content '{expected_content}' not found in {file_name}"
